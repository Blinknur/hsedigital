...
const PermitModal: React.FC<PermitModalProps> = ({ permit, stations, users, contractors, currentUser, onClose, onCreate, onUpdateStatus }) => {
    ...
    const initialFormData = {
        ...
        contractorId: permit?.contractorId || currentUser.contractorId || '',
                    ...
                    <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto pr-2 space-y-4">
                        ...
                        <div>
                            ...
                            <select 
                                ...
                                required
                                disabled={!!currentUser.contractorId}
                            >
                            ...
                            {currentUser.contractorId ? (
                                <p className="text-xs text-emerald-600 mt-1 font-semibold">Auto-selected based on your login profile.</p>
                            ) : (
